...
final class CollectionMethodFilterProviderData
{
    public static function data(): Generator
    {
        yield [
            'collection' => (new BoolCollection())
                ...
                ->add(false),
            'expectedCount' => 1,
            'filter' => static fn (bool $item): bool => $item !== true,
        ];
        ...
        yield [
            ...
            'expectedCount' => 2,
            'filter' => static fn (callable $item): bool => is_int($item()),
        ];
        ...
        yield [
            'collection' => (new IntCollection())
                ...
                ->add(7),
            'expectedCount' => 1,
            'filter' => static fn (int $item): bool => $item < 5,
        ];
        ...
        yield [
            'collection' => (new ArrayCollection())
                ...
                ->add([2,7,9]),
            'expectedCount' => 1,
            'filter' => static fn (array $item): bool => array_sum($item) > 15,
        ];
        ...
        yield [
            'collection' => (new ArrayCollection())
                ...
                ->add([2,7,9]),
            'expectedCount' => 0,
            'filter' => static fn (array $item): bool => array_sum($item) > 55,
        ];
        ...
        yield [
            'collection' => (new NumericCollection())
                ...
                ->add(-1),
            'expectedCount' => 1,
            'fn' => static fn (float $numeric): bool => $numeric < 0,
        ];
